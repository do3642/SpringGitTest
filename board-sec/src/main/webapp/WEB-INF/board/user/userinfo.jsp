<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <form method = "" action = "">
     ...
     <div class="mb-3 mt-3">
       ...
       <input type="text" class="form-control" id="username" placeholder="Enter username" name="username" value = "${principal.user.username}" disabled>
     </div>
     <div class="mb-3">
     ...
     <div class="mb-3">
       ...
       <input type="text" class="form-control" id="createDate" name="createDate" value = "${principal.user.createDate}" disabled>
     </div>
